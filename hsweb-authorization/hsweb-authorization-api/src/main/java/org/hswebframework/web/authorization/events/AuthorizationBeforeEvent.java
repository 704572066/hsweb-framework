...
public class AuthorizationBeforeEvent extends AbstractAuthorizationEvent {
    ...
    public AuthorizationBeforeEvent(String username, String password, String cid, String unionid, Function<String, Object> parameterGetter) {
        super(username, password, cid, unionid, parameterGetter);
    }
